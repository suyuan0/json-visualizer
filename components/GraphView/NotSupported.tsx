...
import { UpgradeContent } from "@/components/modals/UpgradeModal";
    ...
    <StyledNotSupported>
      <StyledContent>
        ...
        <Text c="dimmed" maw="400" my="lg" ta="center">
          JSON Crack is unable to support data of this size. Please try our new editor for better performance.
        </Text>
        <Link rel="noopener" href="https://todiagram.com?utm_source=jsoncrack&utm_medium=data_limit" target="_blank" passHref>

...
import { isContentImage } from "@/lib/jsonParserUtils/calculateNodeSize";
...
const StyledTextNodeWrapper = styled.span<{ $hasCollapse: boolean; $isParent: boolean }>`
  display: flex;
  justify-content: ${({ $hasCollapse, $isParent }) => ($hasCollapse ? "space-between" : $isParent ? "center" : "flex-start")};
  align-items: center;
  height: 100%;
  width: 100%;
  overflow: hidden;
